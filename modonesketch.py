...
def modExFile():
	directory = 'MPEG7dataset\\test\\'+"flatfish"
	im = cv2.imread(os.path.join(directory, os.listdir(directory)[0]))
	...
	pointA = len(startlistOfPoints)*rand
	



	for x in startlistOfPoints:
		xval = x[1]
		yval = x[0]
